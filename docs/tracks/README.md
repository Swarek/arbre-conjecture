...
| C - SAT/CSP | `piste_c_sat_csp.md` | Relations effectives de quartets construites et validées sur scaffold supporté |
...
| F - Complexité / sous-cas | `piste_f_complexity_subcases.md` | 2-SAT/treewidth/catalogue relationnel mesurés ; pas preuve générale |
