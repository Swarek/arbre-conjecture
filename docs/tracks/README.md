...
| T093 | 2026-05-31 | A/B/R004 | Dépendance au contexte : un même ordre local de branches peut satisfaire ou violer une obligation partielle selon les choix internes/contexte | `make bench-partial-context-lab` |
