...
bench-separator-signature-lab:
	mkdir -p reports && \
	$(PYTHON) tools/pc_separator_signature_lab_probe.py \
	  --sizes 4,5,6,7,8 \
	  --pc-trees star,balanced,mixed \
	  --instance-kinds cycle,equal,paired_farthest,random,padded_four_local_non_cr,padded_five_local_non_cr,even_high_cycle_low_hub,odd_high_cycle_low_hub \
	  --repeats 2 \
	  ...
	  --max-examples 8 \
	  --seed 20260640 \
	  --output reports/separator_signature_lab_probe.json

bench-context-signature-ladder:
	mkdir -p reports && \
	$(PYTHON) tools/pc_context_signature_ladder_probe.py \
	  --sizes 4,5,6,7,8 \
	  --pc-trees star,balanced,mixed \
	  --instance-kinds cycle,equal,paired_farthest,random,padded_four_local_non_cr,padded_five_local_non_cr,even_high_cycle_low_hub,odd_high_cycle_low_hub \
	  --repeats 2 \
	  ...
	  --max-examples 8 \
	  --seed 20260650 \
	  --output reports/context_signature_ladder_probe.json

bench-context-gap-relation:
	mkdir -p reports && \
	$(PYTHON) tools/pc_context_gap_relation_probe.py \
	  --sizes 4,5,6,7,8 \
	  --pc-trees star,balanced,mixed \
	  --instance-kinds cycle,equal,paired_farthest,random,padded_four_local_non_cr,padded_five_local_non_cr,even_high_cycle_low_hub,odd_high_cycle_low_hub \
	  --repeats 2 \
	  ...
	  --max-examples 8 \
	  --seed 20260660 \
	  --output reports/context_gap_relation_probe.json

bench-context-gap-composition:
	mkdir -p reports && \
	$(PYTHON) tools/pc_context_gap_composition_probe.py \
	  --sizes 4,5,6,7,8 \
	  --pc-trees star,balanced,mixed \
	  --instance-kinds cycle,equal,paired_farthest,random,padded_four_local_non_cr,padded_five_local_non_cr,even_high_cycle_low_hub,odd_high_cycle_low_hub \
	  --repeats 2 \
	  --frontier-limit 20000 \
	  --projection-tuple-size 2 \
	  --scope all_open \
	  --max-projection-tuples 50000 \
	  --max-examples 8 \
	  --seed 20260670 \
	  --output reports/context_gap_composition_probe.json

bench-context-gap-arity:
	mkdir -p reports && \
	$(PYTHON) tools/pc_context_gap_arity_probe.py \
	  --sizes 4,5,6,7,8 \
	  --pc-trees star,balanced,mixed \
	  --instance-kinds cycle,equal,paired_farthest,random,padded_four_local_non_cr,padded_five_local_non_cr,even_high_cycle_low_hub,odd_high_cycle_low_hub \
	  --repeats 2 \
	  --ladder-depths 3,4,5,6 \
	  --frontier-limit 20000 \
	  --projection-tuple-size 3 \
	  --scope all_open \
	  --max-projection-tuples 50000 \
	  --max-examples 8 \
	  --seed 20260680 \
	  --output reports/context_gap_arity_probe.json

bench-context-gap-multi-arity:
	mkdir -p reports && \
	$(PYTHON) tools/pc_context_gap_multi_arity_probe.py \
	  --sizes 5,6,7,8 \
	  --pc-trees mixed \
...
bench-context-gap-random-arity:
	mkdir -p reports && \
	$(PYTHON) tools/pc_context_gap_random_arity_probe.py \
	  --tuple-sizes 4,5 \
	  --sizes 5,6,7 \
	  --pc-trees balanced,mixed \
	  --instance-kinds cycle,paired_farthest,random,random4,padded_five_local_non_cr \
	  --repeats 1 \
	  --frontier-limit 20000 \
	  --min-distinct-obligations 2 \
	  --scope all_open \
	  ...
	  --max-examples 8 \
	  --seed 20260710 \
	  --output reports/context_gap_random_arity_probe.json

bench-context-gap-binary-components:
	mkdir -p reports && \
	$(PYTHON) tools/pc_context_gap_binary_component_probe.py \
	  --set-sizes 6,8 \
	  --sizes 5,6,7 \
	  --pc-trees balanced,mixed \
	  --instance-kinds cycle,paired_farthest,random,random4,padded_five_local_non_cr \
	  ...
	  --sample-count 800 \
	  --max-attempt-multiplier 20 \
	  --max-product-size 20000 \
	  --max-examples 8 \
	  --seed 20260720 \
	  --output reports/context_gap_binary_component_probe.json

bench-context-gap-join-decomposition:
	mkdir -p reports && \
	$(PYTHON) tools/pc_context_gap_join_decomposition_probe.py \
	  --decomposition-specs 4:4:2,5:5:2 \
	  --sizes 5,6,7 \
	  --pc-trees balanced,mixed \
	  --instance-kinds cycle,paired_farthest,random,random4,padded_five_local_non_cr \
	  --repeats 1 \
